      ...
      <div className="bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-xl w-full max-w-md flex flex-col mx-4">
        ...
        <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={isPending}
            className={`mt-4 bg-slate-600 hover:bg-slate-700 text-white font-semibold py-2 rounded-full shadow-md transition duration-300 ${isPending ? "opacity-70 cursor-not-allowed" : ""
              }`}
          >
