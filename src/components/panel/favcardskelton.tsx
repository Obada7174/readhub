...
export default function FavoriteCardSkeleton() {
  return (
    <div className="flex gap-4 p-4 rounded-2xl border border-gray-200 bg-white dark:bg-slate-800 shadow-sm animate-pulse max-w-xl w-full mx-auto">
      <div className="min-w-[96px] h-36 rounded-xl overflow-hidden bg-gray-300 dark:bg-gray-700" />
