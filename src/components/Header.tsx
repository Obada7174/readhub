                ...
                {isMenuOpen && (
                    <div className="md:hidden mt-4 pb-4">
                        <nav className="flex flex-col space-y-4">
                            <Link href="/books" className="text-gray-800 dark:text-white hover:text-primary">{'books'}</Link>
                            <Link href="/ebooks" className="text-gray-800 dark:text-white hover:text-primary">{'ebooks'}</Link>
                            <Link href="/categories" className="text-gray-800 dark:text-white hover:text-primary">{'categories'}</Link>
                            <Link href="/about" className="text-gray-800 dark:text-white hover:text-primary">{'about'}</Link>
                            <Link href="/dashboard" className="text-gray-800 dark:text-white hover:text-primary">{'dashboard'}</Link>
